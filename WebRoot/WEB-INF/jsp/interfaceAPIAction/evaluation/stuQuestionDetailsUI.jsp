...
<!-- 信息开始 -->
<s:form action="/App/stuQuestion_appStuQuestionDetails.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/stuQuestion_appStuQuestionDetails.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
								<span class="span_apiInfo">
									问题id：<span class="span_apiProperty">id</span>
								</span>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							name：&nbsp;<span class="span_apiSuccess">success</span><span class="span_apiNormal">-->查询成功</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="span_apiWarning">noStuQuesiton</span><span class="span_apiNormal">-->没有找到问题</span>
								
						</span>
						<br/>
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							stuQuestion：&nbsp;<span class="span_apiNormal">学生提问的问题信息</span>
							&nbsp;&nbsp;&nbsp;&nbsp;
