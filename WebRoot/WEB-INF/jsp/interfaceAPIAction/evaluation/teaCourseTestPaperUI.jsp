...
<!-- 信息开始 -->
<s:form action="/App/testPaper_appTeaCourseTestPaper.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/testPaper_appTeaCourseTestPaper.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span class="span_apiSuccess">questionCount</span><span class="span_apiNormal">-->问题数量
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span class="span_apiSuccess">submitCount</span><span class="span_apiNormal">-->提交人数
						</span>
						</span>
						</span>
					</div>
