...
<!-- 信息开始 -->
<s:form action="/App/stuScoreRecord_checkStuAlreadyTest.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/stuScoreRecord_checkStuAlreadyTest.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							name：&nbsp;<span class="span_apiSuccess">noExist</span><span class="span_apiNormal">-->没有做过此测试卷</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="span_apiWarning">noTestPaper</span><span class="span_apiNormal">-->没有找到测试卷</span>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="span_apiWarning">alreadyExist</span><span class="span_apiNormal">-->已经做过</span>
						</span>
						</span>
					</div>
					<!-- 测试 -->
