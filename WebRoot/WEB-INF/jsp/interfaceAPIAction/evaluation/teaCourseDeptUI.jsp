...
<!-- 信息开始 -->
<s:form action="/App/teachProcess_appTeaCourseDept.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/teachProcess_appTeaCourseDept.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							name：&nbsp;<span class="span_apiSuccess">success</span><span class="span_apiNormal">-->查询成功</span>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="span_apiWarning">noDepartment</span><span class="span_apiNormal">-->没有找到部门</span>
								
						</span>
						<br/>
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							departments：&nbsp;<span class="span_apiNormal">部门信息--和对应班级</span>
						</span>
						</span>
						</span>
					</div>
