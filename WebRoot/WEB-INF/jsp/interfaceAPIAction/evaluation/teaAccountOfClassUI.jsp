...
<!-- 信息开始 -->
<s:form action="/App/stuPaperAccount_appTeaCountByCourseClass.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div  class="addFont">
						...
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							stuPaperAccounts：&nbsp;<span class="span_apiNormal">学生测试卷统计信息</span>
						</span>
						</span>
					</div>
					<!-- 测试 -->
