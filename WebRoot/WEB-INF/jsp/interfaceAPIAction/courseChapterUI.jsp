...
<!-- 信息开始 -->
<s:form action="/App/chapter_appCourseChapter.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/chapter_appCourseChapter.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							...
							&nbsp;&nbsp;
							<span class="span_apiWarning">noChapter</span><span class="span_apiNormal">-->此课程没有章节</span>
						</span>
						</span>
					</div>
					<!-- 测试 -->
