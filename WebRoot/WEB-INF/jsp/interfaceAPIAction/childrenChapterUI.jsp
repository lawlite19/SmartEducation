...
<!-- 信息开始 -->
<s:form action="/App/chapter_appChildrenChapter.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/chapter_appChildrenChapter.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
								<span class="span_apiInfo">
									章节id：<span class="span_apiProperty">id</span>
								</span>
					</div>
					<!-- 返回json数据说明-->
					<div  class="addFont">
