...
<!-- 信息开始 -->
<s:form action="/App/department_appDeptLevel3Tea.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/department_appDeptLevel3Tea.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
								<span class="span_apiInfo">
									系id：<span class="span_apiProperty">id</span>
								</span>
					</div>
					<!-- 返回json数据说明-->
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							...
							&nbsp;&nbsp;
							<span class="span_apiWarning">noTeacher</span><span class="span_apiNormal">-->没有老师</span>
						...
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							teachers：&nbsp;<span class="span_apiNormal">老师信息</span>
						</span>
						</span>
						</span>
					</div>
					...
					<div class="addFont">
						<h2>测试</h2>
						<span class="span_apiInfo">
							id: <s:textfield cssClass="inpu" name="id"></s:textfield>eg:3
						</span>
						<br/><br/>
