...
<!-- 信息开始 -->
<s:form action="/App/teacher_appTeacherDept.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/teacher_appTeacherDept.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							department：&nbsp;<span class="span_apiNormal">系信息</span>
						</span>
						</span>
						<br/>
						</span>
