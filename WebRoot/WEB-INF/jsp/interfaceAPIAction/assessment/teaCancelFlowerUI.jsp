...
<!-- 信息开始 -->
<s:form action="/App/stuScoreRecord_appTeaCancelFlower.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/stuScoreRecord_appTeaCancelFlower.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
