...
<!-- 信息开始 -->
<s:form action="/App/stuFlower_appStuFlowerInfo.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/stuFlower_appStuFlowerInfo.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							...
							&nbsp;&nbsp;
							<span class="span_apiWarning">noFlower</span><span class="span_apiNormal">-->没有得到花</span>
						</span>
						<br/>
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							stuFlowers：&nbsp;<span class="span_apiNormal">得到花的信息</span>
						</span>
						</span>
						<br/>
						<span class="span_apiInfo">
