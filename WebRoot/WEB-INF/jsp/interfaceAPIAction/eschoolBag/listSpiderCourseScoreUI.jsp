...
<!-- 信息开始 -->
<s:form action="/App/spiderCourse_listCourseScore.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/spiderCourse_listCourseScore.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						<span class="span_apiProperty">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span class="span_apiWarning">noCourseScore</span><span class="span_apiNormal">-->没有课程评分</span>
						</span>
						<br/>
						<span class="span_apiInfo">
						<span class="span_apiProperty">
							courseScores：&nbsp;<span class="span_apiNormal">-->课程评分信息</span>
						</span>
						</span>
						</span>
					</div>
					...
					<div class="addFont">
						<h2>测试</h2>
						<span class="span_apiInfo">
							courseId: <s:textfield cssClass="inpu" name="courseId"></s:textfield>eg:3
						</span>
						<br/><br/>
