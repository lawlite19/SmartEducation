...
<!-- 信息开始 -->
<s:form action="/App/favorite_appDelete.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/favorite_appDelete.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
					...
					<div  class="addFont">
						...
						name：&nbsp;<span class="span_apiSuccess">success</span><span class="span_apiNormal">-->取消成功</span>
							&nbsp;&nbsp;
