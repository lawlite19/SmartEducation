...
<!-- 信息开始 -->
<s:form action="/App/spiderCourse_appSearchCourse.action" method="post">
<div class="mframe">
			...
			<tr>
				<td colspan="2">
					...
					<div>
							<h2>接口地址</h2>
									<p class="p_apiInfo">
										${pageContext.request.contextPath}/App/spiderCourse_appSearchCourse.action
									</p>
								<br/>
								<h2>需要传递的数据</h2>
								<br/>
								<span class="span_apiInfo">
									搜索关键字：<span class="span_apiProperty">searchInfo</span>
									&nbsp;&nbsp;&nbsp;&nbsp;可从<span class="span_apiPropertyInfo">课程名、作者、大学名称</span>中搜索出符合的结果
								</span>
								<br/>
								<span class="span_apiInfo">
					...
					<div class="addFont">
						<h2>测试</h2>
						<span class="span_apiInfo">
							searchInfo: <s:textfield cssClass="inpu" name="searchInfo"></s:textfield>eg:java
						</span>
						<br/><br/>
						<span class="span_apiInfo">
						pageNum:<s:textfield cssClass="inpu" name="pageNum"></s:textfield>eg:1
						</span>
						<br/><br/>
						<span class="span_apiInfo">
						pageSize: <s:textfield cssClass="inpu" name="pageSize"></s:textfield>eg:10
                        </span>
                        <br/><br/>
