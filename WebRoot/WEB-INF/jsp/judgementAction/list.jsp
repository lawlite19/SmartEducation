            	 ...
            	 $("input:checked").each(function(){
            	 	 var value=$(this).val().split(",");
           	    	 if (confirm("确定要删除"+value[1]+"吗?")) {
           	    		$.ajax({ 
               	    		type: "post",
               	    		url: "judgement_bulkDelete.action", 
               	    		data: {
               	    			"id" : value[0]
           	    			}, 
               	    		dataType : "json",
...
<body>
<!-- 顶层 -->
<div class="crumd"><a href="" id="A1">首页</a> &gt; 题库管理 &gt; 判断题管理</div>
<!-- 查找-->
<s:form action="judgement_list" method="post">
...
<table align="center" cellspacing="3" cellpadding="5">
	<tr>
		<td class="bbtn btn-primary" align="center">
			<s:a action="judgement_addUI" style="color:white;text-decoration: none;">添加题目</s:a>
		</td>
	</tr>
</table>
<div class="mframe">
		...
		<tbody>
			<s:iterator value="recordList" status="s">
				<tr onmouseover="SetNewColor(this);" onmouseout="SetOldColor(this);">
					...
					|
					<s:a action="judgement_delete?id=%{id}" onclick="return window.confirm('您确定要删除吗？')">
