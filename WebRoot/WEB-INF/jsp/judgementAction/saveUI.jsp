...
<head>
	...
	function Check() {
       ...
       // if (!MM_Empty('txt_question', '题目')) return false;
        if (!MM_Empty('radio_answer', '答案')) return false;
        layer.load();
    }
	</script>
	<!-- 根据课程动态加载章节 -->
...
<body>
<!-- 顶层 -->
<div class="crumd"><a href="" id="A1">首页</a> &gt; 题库管理 &gt; 判断题管理 &gt;
<s:if test="%{id == null}">
添加判断题信息
</s:if>
<s:else>
          ...
          <tbody>
            ...
            <tr>
                <td class="tm">
                    ...
                    <td class="mm">
                    <div>
<s:form action="judgement_%{id == null ? 'add' : 'edit'}">
...
<table cellspacing="0" cellpadding="6"  align="center" border="0">
		...
		<tbody> 
					...
					<tr><td  class="addFont">答案</td>
                        <td>
							<s:radio name="answer" list="#{'Y' : '正确', 'N' : '错误'}" id="radio_answer"></s:radio>
							<span class="span_note">*</span>
						</td>
                    </tr>
