...
<body>
<!-- 顶层 -->
<div class="crumd"><a href="" id="A1">首页</a> &gt; 教学质量管理 &gt; 学生评价指标管理</div>
<!-- 引入选择按钮 -->
...
<table align="center" cellspacing="5" cellpadding="5">
 ...
 <div class="mframe">
	...
	<table class="grid" cellspacing="0" cellpadding="6" rules="all" itemstyle-cssclass="tdbg" align="center" border="1" id="gvUserInfo">
		...
		<!--显示数据列表-->
		<tbody>
			<s:iterator value="stuAccountList" status="s">
				<tr onmouseover="SetNewColor(this);" onmouseout="SetOldColor(this);">
					...
					<td align="center">
					<s:a action="stuAccount_editUI?id=%{id}">
						<img style="border: 0px;" src="${pageContext.request.contextPath}/style/images/edit.gif" />
					</s:a>
					|
					<s:a action="stuAccount_delete?id=%{id}" onclick="return window.confirm('您确定要删除吗？')">
