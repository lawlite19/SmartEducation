...
<!-- 登录 -->
   <form id="formLogin" action="user_logintestmonitor.action" method="post">
                             ...
                             <%--登录表单开始--%>
                                <table style="width: 90%; margin-left: 5px; margin-top: 10px;">
                                    ...
                                    <td colspan="2" style="text-align: left; font-size: 14px; padding-left:80px" >
                                    		<input id="teacher" type="radio" value="监考老师" name="userType" checked="checked"/>
                                        	<label for="teacher">监考老师</label>
                                        	
                                        	<input id="manager" type="radio" value="考试系统管理员" name="userType" />
